...
export default function LoveLetter() {
  ...
  return (
    <div className="relative min-h-screen pt-24 pb-16 flex flex-col items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-[550px] min-h-[400px] flex items-center justify-center z-10">
        ...
        >
          ...
          <div
            style={{
              transform: isOpen ? 'translateY(-65%) scale(1)' : 'translateY(0) scale(0.95)',
              zIndex: isOpen ? 30 : 10,
          ...
          >
            ...
            {/* Letter Text */}
            <div className="font-serif text-sm md:text-base text-textDark/85 italic leading-8 flex-grow select-text">
              <p className="mb-4">
                Every single moment spent with you has become a precious, beautiful part of my life. You are my peace, my deepest happiness, and my home. Thank you for being exactly who you are.
              </p>
              <p className="mb-4">
                I promise to cherish you, laugh with you, hold you close in hard times, and love you today, tomorrow, and forever.
              </p>
            </div>

            {/* Signature */}
            <div className="mt-4 text-right">
              <p className="text-sm text-textDark/65">With all my heart,</p>
              <p className="text-[#FF6FA7] font-serif text-base md:text-lg font-bold italic mt-1">
                Forever Yours ❤️
              </p>
            </div>
          </div>
